...
GPU = make_list_gpu_ref.out make_list_gpu_roc.out make_list_gpu_smem.out make_list_gpu_smem_coars.out make_list_gpu_smem_cell.out make_list_gpu_smem_once.out make_list_gpu_warp_unroll.out make_list_gpu_warp_unroll_fused_loop.out
